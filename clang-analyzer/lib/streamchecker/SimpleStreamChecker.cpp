...
void SimpleStreamChecker::reportDoubleClose(SymbolRef FileDescSym,
    ...
    auto R = std::make_unique<PathSensitiveBugReport>(
        *DoubleCloseBugType, "Closing a previously closed file stream",
        ErrNode);
...
ProgramStateRef SimpleStreamChecker::checkPointerEscape(
    ...
    for (InvalidatedSymbols::const_iterator I = Escaped.begin(),
        ...
        // file handle will be closed somewhere else.
        State = State->remove<StreamMap>(Sym);
    }
    return State;
}
...
extern "C" __attribute__((visibility("default"))) void clang_registerCheckers(
